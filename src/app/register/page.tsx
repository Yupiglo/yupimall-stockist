...
import BgStockist from "@/assets/images/bg-stockist.png";
            ...
            >
                <Paper elevation={0} sx={{ p: 4, borderRadius: 4, maxWidth: 500, textAlign: "center", border: "1px solid", borderColor: "divider" }}>
                    ...
                    <Typography color="text.secondary" sx={{ mb: 3 }}>
                        Votre demande d'adhésion au réseau de stockistes a été enregistrée. Elle sera examinée par notre équipe. Vous allez être redirigé vers la page de connexion.
                    </Typography>
    ...
    return (
        <Grid container component="main" sx={{ height: "100vh", overflow: "hidden" }}>
            <Grid
                ...
                sx={{
                    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("${BgStockist.src}")`,
            ...
            >
                <Box sx={{ position: "relative", zIndex: 1, textAlign: "left", width: "100%", mt: "auto" }}>
                    <Typography variant="h2" fontWeight="900" gutterBottom sx={{ textShadow: "2px 2px 4px rgba(0,0,0,0.5)", lineHeight: 1.1 }}>
                        Gérez Votre Stock<br />en Temps Réel
                    </Typography>
                    <Typography variant="h5" sx={{ opacity: 0.9, maxWidth: 500, fontWeight: 500, mt: 2 }}>
                        Rejoignez YupiFlow en tant que stockiste et accédez à des outils de pointe pour optimiser votre rentabilité et votre visibilité.
                    </Typography>
                </Box>
            </Grid>
            <Grid
